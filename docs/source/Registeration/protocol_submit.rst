...
* **Sequencing Protocol**: This protocol refers to steps taken after sampling util a library is prepared for sequencing.
...
* **Analyais Protocol**: This protocol refers to steps taken for processing the sample you have uploaded to MSD.
  As all your 16S amplicon sequences get analyzed at MSD, you don't need to define any *Analyais* protocols and you can use the one provided by MSD: *Analysis_protocol_Default*
